<?php
namespace Techievolve\Banners\Block\Adminhtml\Banners\Edit\Tab;
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(['data' => ['html_id_prefix' => 'banners_image_']]);
        ...
        $this->_eventManager->dispatch('adminhtml_banners_edit_tab_image_prepare_form', ['form' => $form]);
    ...
    {
        return ['image' => 'Techievolve\Banners\Block\Adminhtml\Form\Element\Image'];
    }
}
