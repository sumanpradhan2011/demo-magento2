...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Techievolve_Banners::banners_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('banners')->getId()) {
            return __("Edit Banner '%1'", $this->escapeHtml($this->_coreRegistry->registry('banners')->getTitle()));
        } else {
    ...
    {
        return $this->getUrl('banners/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
