 ...
 * Banners data helper
 */
namespace Techievolve\Banners\Helper;
...
{
    /**
     * Path to store config where count of banners posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'banners/view/items_per_page';
    ...
    /**
     * Remove Banners item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Techievolve\Banners\Model\Banners $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Banners Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Banners Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getBannersPerPage()
    {
