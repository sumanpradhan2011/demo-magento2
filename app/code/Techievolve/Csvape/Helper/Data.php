...
{
    /**
     * Path to store config where count of csvape posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'csvape/view/items_per_page';
    ...
    /**
     * Remove Csvape item image by image filename
     *
    ...
    /**
     * Return URL for resized Csvape Item Image
     *
     * @param Techievolve\Csvape\Model\Csvape $item
     * @param integer $width
     * @param integer $height
     * @return bool|string
     */
    public function resize(\Techievolve\Csvape\Model\Csvape $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Csvape Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Csvape Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getCsvapePerPage()
    {
